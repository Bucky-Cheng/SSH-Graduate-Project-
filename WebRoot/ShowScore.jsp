...
<html>
  ...
  <body>
			...
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar" style="margin-left:-25%">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto mu-navbar-nav" id="AddUL">
			      ...
			      <li class="nav-item active"><a href="SSAction" style="font-size:15px">考核结果</a></li>
	...
	<center>
		...
		<tbody id="tbody1">
			<s:iterator value="SSL" status="li">
			<tr>
			...
			<td ><s:property value="Serve"/></td>
			<td ><s:property value="Assistant"/></td>
			<td ><s:property value="AllScore"/></td>
			</tr>
			</s:iterator>
