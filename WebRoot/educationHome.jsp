...
<html>
  ...
  <body>
			...
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar" style="margin-left:-26%">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:-20%;padding-top:15px">
			    <ul class="navbar-nav mr-auto mu-navbar-nav">
			      ...
			      <li class="nav-item active"><a href="educationTable?flag=a" style="font-size:15px">教学自评</a></li>
	...
	<div class="table-responsive" style="width:70%">
		...
		<div id="SDEL">
		  <i class="fa fa-exclamation" style="color:red"></i><span>请输入教学表分值权重</span>
...
remake();
	...
	jQuery.ajax({
		...
		success:function(data){
			...
			var json=eval('('+data+')');
			jQuery("#qualityContent").val(json[0].eduQuality);
    ...
    function tableMake(){
	 ...
	 jQuery.ajax({
		...
		success:function(data){
			...
			var json=eval('('+data+')');
			jQuery("#quality").html(json[0].education);
