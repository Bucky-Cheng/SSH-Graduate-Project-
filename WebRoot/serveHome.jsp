...
<html>
  ...
  <body>
			...
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar" style="margin-left:-25%">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto mu-navbar-nav" id="AddUL">
			      ...
			      <li class="nav-item  active"><a href="GetSerTable" style="font-size:15px">服务自评</a></li>
	...
	<div class="table-responsive" style="width:70%">
		...
		<div id="SDEL">
		  <i class="fa fa-exclamation" style="color:red"></i><span>请输入服务表分值权重</span>
...
jQuery.ajax({
	...
	jQuery.ajax({
		...
		success:function(data){
			...
			var json=eval('('+data+')');
			jQuery("#qualityContent").val(json[0].serQuality);
    ...
    function tableMake(){
	 ...
	 jQuery.ajax({
		...
		success:function(data){
			...
			var json=eval('('+data+')');
			jQuery("#quality").html(json[0].serve);
