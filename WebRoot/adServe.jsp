...
<html>
  ...
  <body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            ...
                            <li><i class="fa fa-bars"></i><a href="educationTable?flag=c">评分项目管理</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                             <li><i class="menu-icon fa fa-th"></i><a href="TurnQ">权重修改</a></li></ul>
                    </li>
                     <li class="menu-item-has-children dropdown">
	...
	<div class="table-responsive" style="width:70%">
		...
		<a href="GetMSerTable"><button type="button" class="btn btn-info" style="float:right" >修改评分表</button></a>
	</div>
	<!-- .animated -->
        </div>
        <!-- /.content -->
