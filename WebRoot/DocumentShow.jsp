  ...
  <body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="charts-chartjs.html">退回评分表</a></li>
	...
	<div class="table-responsive" style="width:70%">
		...
		<tbody id="tbody1">
			...
			<td><a href="FileDownload?path=<s:property value='Education'/>"><s:property value="Education"/></a></td>
			<td><a><s:property value="Research"/></a></td>
			<td><a><s:property value="Serve"/></a></td>
			<td><a><s:property value="Assistant"/></a></td>
			</tr>
			</s:iterator>
