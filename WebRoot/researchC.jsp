...
<html>
  ...
  <body>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="table-responsive" style="width:50%;float:left">
		...
		<center>
			...
			<tbody>
				<s:iterator value="researchList" status="li">
				<tr>
			...
			<span id="jsonArraySpan" style="display:none">${sessionScope.relist} </span>
	...
	function initialDeltr1(nowTr){
					...
					url:"delCombinationARAjaxAction",
					type:"post",
					data:{name:name},
					dataType:  "text",
	...
	function initialDeltr2(nowTr){
					...
					url:"delCombinationBRAjaxAction",
					type:"post",
					data:{name:name},
					dataType:  "text",
					success:function(data){
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationARAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationBRAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
		...
		url:"saveCombinationARAjaxAction",
		type:"post",
...
　					}
		...
		url:"saveCombinationBRAjaxAction",
		type:"post",
		data:{including:JSON.stringify(selectedList)},
		dataType:  "json", 
		success:function(data){
