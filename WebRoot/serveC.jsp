...
<html>
  ...
  <body>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="table-responsive" style="width:50%;float:left">
		...
		<center>
			...
			<tbody>
				<s:iterator value="serveList" status="li">
				<tr>
			...
			<span id="jsonArraySpan" style="display:none">${sessionScope.serlist} </span>
	...
	function initialDeltr1(nowTr){
					...
					url:"delCombinationASAjaxAction",
					type:"post",
					data:{name:name},
					dataType:  "text",
	...
	function initialDeltr2(nowTr){
					...
					url:"delCombinationBSAjaxAction",
					type:"post",
					data:{name:name},
					dataType:  "text",
					success:function(data){
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationASAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationBSAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
		...
		url:"saveCombinationASAjaxAction",
		type:"post",
...
　					}
		...
		url:"saveCombinationBSAjaxAction",
		type:"post",
		data:{including:JSON.stringify(selectedList)},
		dataType:  "json", 
		success:function(data){
