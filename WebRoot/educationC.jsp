  ...
  <body>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="table-responsive" style="width:50%;float:left">
		...
		<center>
			...
			<span id="jsonArraySpan" style="display:none">${sessionScope.list} </span>
	...
	function initialDeltr2(nowTr){
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationAAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
	 ...
	 jQuery.ajax({
		...
		url:"showCombinationBAjaxAction",
		type:"post",
		data:{},
		dataType:  "json", 
		success:function(data){
...
　					}
		...
		url:"saveCombinationAAjaxAction",
		type:"post",
...
　					}
		...
		url:"saveCombinationBAjaxAction",
		type:"post",
		data:{including:JSON.stringify(selectedList)},
		dataType:  "json", 
		success:function(data){
